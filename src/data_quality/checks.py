"""
Reusable PySpark data quality framework.

Runs completeness, uniqueness, referential integrity, freshness and row-count
anomaly checks against a DataFrame, and aggregates the results into a single
quality report that can gate promotion between medallion layers.
"""
...
class DataQualityChecker:
    """Collection of PySpark-native data quality checks."""
